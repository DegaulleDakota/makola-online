    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-gray-900 mb-4">About Makola Online</h1>
          <p className="text-xl text-gray-600">Ghana's Premier Marketplace</p>
        </div>
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-gray-700">WhatsApp: [Your WhatsApp Number]</p>
              <p className="text-gray-700">Email: [Your Support Email]</p>
            </div>
            <div>
