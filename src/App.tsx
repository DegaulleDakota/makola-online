            ...
            <Routes>
              ...
              <Route path="/admin/change-password" element={
                <AdminChangePassword 
                  ...
                  onPasswordChanged={() => window.location.href = '/admin'} 
                />
              } />
              ...
              {/* Rider routes */}
              <Route path="/rider/register" element={<><GlobalHeader /><div className="py-8"><RiderRegistration onSuccess={() => window.location.href = '/rider'} /></div></>} />
              <Route path="/rider/login" element={<><GlobalHeader /><div className="py-8"><RiderLogin onSuccess={() => window.location.href = '/rider'} /></div></>} />
